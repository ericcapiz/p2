    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          <h2>Overview</h2>
          <p>
            This app will allow users to view current stats on various crypto
            currencies. Users can search for most crypto currencies to view
            stats, price changes, etc. Once users create a new account, they
